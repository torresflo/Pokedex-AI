...
class MainWindow(QtWidgets.QWidget):
    ...
    def fillPokemonData(self, pokemonNumber):
        ...
        self.m_pokemonImageLabel.setPixmap(QtGui.QPixmap(f"{DataSaver.DefaultPokemonImageDataFolderPath}/{pokemonNumber}/{DataSaver.SpriteFrontDefaultName}"))
        ...
        self.m_pokemonWeightLabel.setText(f"Weight: {pokemonData[Pokedex.JsonWeightKey]/1000} kilogrammes")
